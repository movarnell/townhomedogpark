...
// There are some repeated functions in there that are also shared in `TodaysSchedule`.
// You should extract them into a shared file and import them into both components.
// Perhaps you've heard the adage, "Don't Repeat Yourself" (DRY). This is one of the
